...
var menu_site = [
  { label: "menu01", submenus: [
    { label: "menu01-01", pc: "p_selc"},
    { label: "menu01-02", pc: "p_rslt"}] },
  { label: "menu02", submenus: [
    { label: "menu02-01", pc: "p_hist"},
    { label: "menu02-02", pc: "p_cord"},
    { label: "menu02-03", pc: "p_lpes"},
    { label: "menu02-04", pc: "p_prof"},
    { label: "menu02-05", pc: "p_disc"},
    { label: "menu02-06", pc: "p_egre"}] },
