...
var pfale_txt_br = {
  'head': "Fale Conosco",
  'label': "Contato",
  'par-01': 'Para facilitar o contato com a Coordenação, as seguintes opções são disponibilizadas para o atendimento de demandas. <span style="font-weight: bold;">No entanto, se você tem alguma dúvida sobre os procedimentos acadêmicos do PGSC, por favor, veja primeiro as informações em Procedimentos Acadêmicos antes de entrar em contato direto conosco</span>.',
  'par-02': "Eletrônico",
  'par-03': "Via e-mail oficial da Coordenação da Graduação no endereço",
  'par-04': "Presencial",
...
var pfale_txt_en = {
  ...
  'par-02': "E-mail",
  'par-03': "Graduation Coordination e-mail",
  'par-04': "Main Address",
...
var contatos=[
  {'local':'Chefia da Seção de Engenharia de Computação','pessoa':'TC Anderson Fernandes Pereira dos Santos – D.Sc.','tel':'00 55 21 2546-7090','email':'chefe_se9@ime.eb.br'},
  {'local':'Coordenação de Graduação','pessoa':'Prof. Raquel Coelho Gomes Pinto – D.Sc.','tel':'00 55 21 2546-7096','email':'coord_grad_se9@ime.eb.br'}
